                    ...
                    <div id="step1"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" id="name" value="{{ old('name') }}" name="name" class="form-control rounded" maxlength="20" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                <label for="interviewSuitableTime">What is suitable time for interview?<span
                                        class="color-red font-weight-bold">*</span></label>
                                <input type="text" value="{{ old('interviewSuitableTime') }}" id="interviewSuitableTime" name="interviewSuitableTime" class="form-control rounded" maxlength="20" >
                            </div>
                            <div class="col-6 mb-3">
                    ...
                    <div id="step4"
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <textarea id="loginBio"  name="loginBio" class="form-control rounded" maxlength="50">{{ old('loginBio') }}</textarea>
                            </div>
                            <div class="col-6 mb-3">
                                <label for="goodQuality">What are some good qualities of perfect astrologer?<span
                                        class="color-red font-weight-bold">*</span></label>
                                <textarea id="goodQuality"  name="goodQuality" class="form-control rounded" maxlength="50">{{ old('goodQuality') }}</textarea>
                            </div>
                            <div class="col-6 mb-3">
                                ...
                                <textarea id="biggestChallenge"  name="biggestChallenge" class="form-control rounded" maxlength="50">{{ old('biggestChallenge') }}</textarea>
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <textarea id="whatwillDo"  name="whatwillDo" class="form-control rounded" maxlength="50">{{ old('whatwillDo') }}</textarea>
                            </div>
                        </div>
                        <div class="col-12 text-center">
                            <a class="btn btn-chat btn-chat-lg font-weight-bold px-5 py-2"
