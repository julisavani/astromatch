                        ...
                        <div class="tab-content">
                            <div class="col-12 pt-4 mt-3 tab-pane fade show active" id="dailyData">
                                <h2 class="cat-heading mb-4">Free <span
                                    class="color-red">
                                <!--    {{ $horoscope['vedicList']['todayHoroscope'][0]['zodiac'] }}</span> Daily-->
                                ...
                                <div class="d-md-flex align-items-start" >
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="shadow-pink rounded-10 mb-5">
                                            <div class="bg-pink">
                            ...
                            <div class="col-12 pt-4 mt-3 tab-pane fade" id="weeklyData">
                                <h2 class="cat-heading mb-4">Free <span
                                    class="color-red">{{ $horoscope['vedicList']['weeklyHoroScope'][0]['zodiac'] }}</span> Weekly
                                Horoscope, {{ $horoscope['vedicList']['weeklyHoroScope'][0]['start_date'] }} To {{ $horoscope['vedicList']['weeklyHoroScope'][0]['end_date'] }}
                            </h2>
                                <div class="d-md-flex align-items-start " >
                                    <img src="/{{ $signRcd[0]->image }}" style="max-height: 140px"
                                        class="mr-md-3 mx-auto d-block" alt="Aries">
                                        ...
                                        <div class="shadow-pink rounded-10 mb-5">
                                            <div class="bg-pink">
                                                <h3 class="text-center font-weight-bold color-red py-2">Weekly's Lucky Color
                                                    and
                                                    Number For {{ $horoscope['vedicList']['weeklyHoroScope'][0]['zodiac'] }}
                                                </h3>
                                            </div>
                                            <div class="px-3">
                                                <div class="row">
                            ...
                            <div class="col-12 pt-4 mt-3 tab-pane fade " id="yearlyData">
                                <h2 class="cat-heading mb-4">Free <span
                                    class="color-red">{{ $horoscope['vedicList']['todayHoroscope'][0]['zodiac'] }}</span> Yearly
                                Horoscope, {{ date('Y') }}
                            </h2>
                                <div class="d-md-flex align-items-start ">
                                    <img src="/{{ $signRcd[0]->image }}" style="max-height: 140px"
                                    ...
                                    <div class="media-body">
                                        <div class="dailyhoroscope-content mt-3">
                                            ...
                                            <p>Health Remark :</p><p> {{ $horoscope['vedicList']['yearlyHoroScope'][0]['health_remark'] }}</p>
                                            <p>Relationship Remark :</p><p> {{ $horoscope['vedicList']['yearlyHoroScope'][0]['relationship_remark'] }}</p>
                                            <p>Travel Remark :</p><p> {{ $horoscope['vedicList']['yearlyHoroScope'][0]['travel_remark'] }}</p>
                                            <p>Family Remark :</p><p> {{ $horoscope['vedicList']['yearlyHoroScope'][0]['family_remark'] }}</p>
                                            <p>Friends Remark :</p><p> {{ $horoscope['vedicList']['yearlyHoroScope'][0]['friends_remark'] }}</p>
                                            <p>Finances Remark :</p><p> {{ $horoscope['vedicList']['yearlyHoroScope'][0]['finances_remark'] }}</p>
                                            <p>Status Remark :</p><p> {{ $horoscope['vedicList']['yearlyHoroScope'][0]['status_remark'] }}</p>
                                        </div>
