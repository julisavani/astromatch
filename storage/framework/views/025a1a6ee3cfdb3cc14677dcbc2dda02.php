...
<?php $__env->startSection('subcontent'); ?>
    ...
    <div class="grid-cols-12 mt-10" style="width:100%">
        ...
        <form action="<?php echo e(route('horoscope')); ?>" method="POST" enctype="multipart/form-data" class="addbtn">
            <?php echo csrf_field(); ?>
        ...
        <nav class="w-full sm:w-auto sm:mr-auto">
            <ul class="pagination" id="pagination">
                <li class="page-item <?php echo e($page == 1 ? 'disabled' : ''); ?>">
                    <a class="page-link"
                        href="<?php echo e(route('horoscope', ['page' => $page - 1, 'searchString' => $searchString])); ?>">
                ...
                <?php for($i = 0; $i < $totalPages; $i++): ?>
                    <li class="page-item <?php echo e($page == $i + 1 ? 'active' : ''); ?> ">
                        <a class="page-link"
                            href="<?php echo e(route('horoscope', ['page' => $i + 1, 'searchString' => $searchString])); ?>"><?php echo e($i + 1); ?></a>
                    </li>
                <?php endfor; ?>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/pages/horoscope.blade.php ENDPATH**/ ?>