<div class="astroway-footer">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-7 col-lg-9">
                    <div class="row">
                                ...
                                <ul class="list-unstyled">
                                  ...
                                  ?>
                                   <?php $__currentLoopData = $getAstrologerCategory['recordList']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a href="<?php echo e(route('front.chatList',['astrologerCategoryId'=>$category['id']])); ?>"
                                            class="font-14 color-pink-light"><?php echo e($category['name']); ?></a></li>
                        ...
                        <div class="col-6 col-md-3">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="<?php echo e(route('front.getPanchang')); ?>"
                            ...
                            <ul class="list-unstyled">
                                <li><a href="<?php echo e(route('front.kundaliMatch')); ?>"
                                        class="font-14 color-pink-light">Kundali Matching</a></li>
                                <li><a href="<?php echo e(route('front.getkundali')); ?>"
                        ...
                        <div class="col-6 col-md-3">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="<?php echo e(route('front.horoScope')); ?>"
                            ...
                            <h4 class="d-block text-white font-16 font-weight-semi-bold mb-3  mt-4 pt-2"><a
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="<?php echo e(route('front.astrologerlogin')); ?>"
                                            class="font-14 color-pink-light">Astrologer Login</a></li>
                                    <li><a href="<?php echo e(route('front.astrologerregister')); ?>"
                        ...
                        <div class="col-6 col-md-3">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="<?php echo e(route('front.aboutus')); ?>"
                            ...
                            <li><a href="<?php echo e(route('front.contact')); ?>"
                                ...
                                <li><a href="<?php echo e(route('front.getBlog')); ?>" class="font-14 color-pink-light"
                                      >Blog</a></li>
                            </ul>
                            <h4 class="d-block text-white font-16 font-weight-semi-bold mb-3 mt-4 pt-2">Policy
                            </h4>
                            <ul class="list-unstyled">
                                <li><a href="<?php echo e(route('front.privacyPolicy')); ?>"
                                        class="font-14 color-pink-light"
                                        rel="nofollow noopener noreferrer">Privacy Policy</a></li>
                                <li><a href="<?php echo e(route('front.termscondition')); ?>"
                                        class="font-14 color-pink-light"
                ...
                <div class="col-sm-12 col-md-4 col-lg-3 offset-md-1 offset-lg-0 pl-md-4">
                    ...
                    <div class="d-flex mt-2 flex-wrap">
                        <a class="mr-2 mt-2" target="_blank" href="<?php echo e($facebook->value); ?>"
                            rel="nofollow"><img
                                src="<?php echo e(asset('public/frontend/astrowaycdn/dashaspeaks/web/content/astroway/images/fb.svg')); ?>"
                                alt="facebook" width="31" height="31" loading="lazy"></a>
                        <a class="mr-2 mt-2" target="_blank" href="#"
                            rel="nofollow"><img
                                src="<?php echo e(asset('public/frontend/astrowaycdn/dashaspeaks/web/content/astroway/images/twitter.svg')); ?>"
                                alt="twitter" width="31" height="31" loading="lazy"></a>
                        <a class="mr-2 mt-2" target="_blank"
                            href="<?php echo e($linkedIn->value); ?>" rel="nofollow"><img
                                src="<?php echo e(asset('public/frontend/astrowaycdn/dashaspeaks/web/content/astroway/images/linkedin.svg')); ?>"
                                alt="linkedin" width="31" height="31" loading="lazy"></a>
                        <a class="mr-2 mt-2" target="_blank"
                            href="<?php echo e($instagram->value); ?>" rel="nofollow"><img
                                src="<?php echo e(asset('public/frontend/astrowaycdn/dashaspeaks/web/content/astroway/images/insta.svg')); ?>"
                                alt="instagram" width="31" height="31" loading="lazy"></a>
                        <a class="mr-2 mt-2" target="_blank"
                            href="<?php echo e($youtube->value); ?>"
                            rel="nofollow"><img
                        ...
                        <a class="mr-2 mt-2" target="_blank" href="<?php echo e($pintrest->value); ?>"
                            rel="nofollow"><img
                                src="<?php echo e(asset('public/frontend/astrowaycdn/dashaspeaks/web/content/astroway/images/pinterest.svg')); ?>"
    ...
    <div class="bg-brown-dark copyright">
        <div class="container py-3">
            <p class="text-center text-white mb-1">Copyright &copy; 2020-<?php echo e(date('Y')); ?> Astroway. All
                Rights Reserved</p>
...
<?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/frontend/layout/footer.blade.php ENDPATH**/ ?>