...
<?php $__env->startSection('subcontent'); ?>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                <form action="<?php echo e(route('productCategories')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="w-56 relative text-slate-500" style="display:inline-block">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('productCategories')); ?>"><i
    ...
    <?php if($totalRecords > 0): ?>
        <div class="grid grid-cols-12 gap-6 mt-5 grid-table">
            <?php $__currentLoopData = $astroMall; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productCat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="intro-y col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-3">
                    <div class="box">
                        <div class="p-5">
                            <div
                                class="h-40 2xl:h-56 image-fit rounded-md overflow-hidden before:block before:absolute before:w-full before:h-full before:top-0 before:left-0 before:z-10 before:bg-gradient-to-t before:from-black before:to-black/10">
                                <img alt="Product image" class="rounded-md" src="/<?php echo e($productCat['categoryImage']); ?>">
                                <div class="absolute bottom-0 text-white px-5 pb-6 z-10">
                                    <a href="" class="block font-medium text-base"><?php echo e($productCat['name']); ?></a>
                                </div>
                            </div>
                        </div>
                        <div
                            ...
                            <a id="editbtn" href="javascript:;"
                                onclick="editbtn(<?php echo e($productCat['id']); ?> , '<?php echo e($productCat['name']); ?>','<?php echo e($productCat['categoryImage']); ?>')"
                            ...
                            <div
                                ...
                                <input class="toggle-class show-code form-check-input mr-0 ml-3" type="checkbox"
                                    ...
                                    <?php echo e($productCat['isActive'] ? 'checked' : ''); ?>

                                    onclick="editAstroMallStatus(<?php echo e($productCat['id']); ?>,<?php echo e($productCat['isActive']); ?>)"
    ...
    <div id="edit-modal" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('editAstroMallApi')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div id="input" class="p-5">
                        <div class="preview">
                            <div class="mt-3">
            ...
            <nav class="w-full sm:w-auto sm:mr-auto">
                <ul class="pagination">
                    <li class="page-item <?php echo e($page == 1 ? 'disabled' : ''); ?>">
                        <a class="page-link" href="<?php echo e(route('productCategories', ['page' => $page - 1])); ?>">
                    ...
                    <?php for($i = 0; $i < $totalPages; $i++): ?>
                        <li class="page-item <?php echo e($page == $i + 1 ? 'active' : ''); ?> ">
                            <a class="page-link"
                                href="<?php echo e(route('productCategories', ['page' => $i + 1])); ?>"><?php echo e($i + 1); ?></a>
                        </li>
                    <?php endfor; ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <form action="<?php echo e(route('astroMallStatusApi')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        jQuery("#add-data").submit(function(e) {
            ...
            jQuery.ajax({
                type: 'POST',
                url: "<?php echo e(route('addAstroMallApi')); ?>",
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/pages/astroMall.blade.php ENDPATH**/ ?>