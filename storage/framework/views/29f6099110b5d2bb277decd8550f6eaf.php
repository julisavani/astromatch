    ...
    <div class="d-inline addbtn intro-y col-span-12">
        <nav class="w-full sm:w-auto sm:mr-auto">
            <ul class="pagination">
                ...
                <?php if($startPage > 1): ?>
                    <li class="page-item">
                        <a class="page-link" href="<?php echo e(route('story-list', ['page' => 1])); ?>">1</a>
                    </li>
                    <?php if($startPage > 2): ?>
                ...
                <?php for($i = $startPage; $i <= $endPage; $i++): ?>
                    <li class="page-item <?php echo e($page == $i ? 'active' : ''); ?>">
                        <a class="page-link" href="<?php echo e(route('story-list', ['page' => $i])); ?>"><?php echo e($i); ?></a>
                    </li>
                <?php endfor; ?>
                ...
                <?php if($endPage < $totalPages): ?>
                    ...
                    <?php endif; ?>
                    <li class="page-item">
                        <a class="page-link" href="<?php echo e(route('story-list', ['page' => $totalPages])); ?>"><?php echo e($totalPages); ?></a>
                    </li>
                <?php endif; ?>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/pages/story-list.blade.php ENDPATH**/ ?>