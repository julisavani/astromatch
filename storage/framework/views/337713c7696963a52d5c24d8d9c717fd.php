                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $chatHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="intro-x">
                            ...
                            <td class="text-center">
                                <?php echo e(date('d-m-Y h:i A', strtotime($chat->updated_at)) ? date('d-m-Y h:i A', strtotime($chat->updated_at)) : '--'); ?>
            ...
            <nav class="w-full sm:w-auto sm:mr-auto">
                <ul class="pagination" id="pagination">
                    ...
                    <?php if($startPage > 1): ?>
                        <li class="page-item">
                            <a class="page-link"
                                href="<?php echo e(route('chatHistory', ['page' => 1, 'searchString' => $searchString])); ?>">1</a>
                        </li>
                        <?php if($startPage > 2): ?>
                    ...
                    <?php for($i = $startPage; $i <= $endPage; $i++): ?>
                        <li class="page-item <?php echo e($page == $i ? 'active' : ''); ?>">
                            <a class="page-link"
                                href="<?php echo e(route('chatHistory', ['page' => $i, 'searchString' => $searchString])); ?>"><?php echo e($i); ?></a>
                        </li>
                    <?php endfor; ?>
                    ...
                    <?php if($endPage < $totalPages): ?>
                        ...
                        <li class="page-item">
                            <a class="page-link"
                                href="<?php echo e(route('chatHistory', ['page' => $totalPages, 'searchString' => $searchString])); ?>"><?php echo e($totalPages); ?></a>
                        </li>
                    <?php endif; ?>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/pages/chat-history-report.blade.php ENDPATH**/ ?>