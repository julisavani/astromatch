            ...
            <table class="table table-report -mt-2" aria-label="horor-scope-sign">
                ...
                <tbody>
                    <?php
                        $no = 0;
                    ?>
                    <?php $__currentLoopData = $signs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $horoScope): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="intro-x">
                            <td><?php echo e(($page - 1) * 15 + ++$no); ?></td>
                            <td>
                                <div class="flex">
                                    <div class="w-10 h-10 image-fit zoom-in">
                                        <img class="rounded-full" src="/<?php echo e($horoScope['image']); ?>"
                            ...
                            <td>
                                <div class="font-medium whitespace-nowrap"><?php echo e($horoScope['name']); ?></div>
                                ...
                                <div
                                 ...
                                 mt-3 sm:mt-0">
                                    <input class="toggle-class show-code form-check-input mr-0 ml-3" type="checkbox"
                                        ...
                                        <?php echo e($horoScope['isActive'] ? 'checked' : ''); ?>

                                        onclick="editHoroScope(<?php echo e($horoScope['id']); ?>,'<?php echo e($horoScope['name']); ?>',<?php echo e($horoScope['isActive']); ?>)"
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a id="editbtn" href="javascript:;"
                                        onclick="editbtn(<?php echo e($horoScope['id']); ?> , '<?php echo e($horoScope['name']); ?>','<?php echo e($horoScope['image']); ?>')"
            ...
            <nav class="w-full sm:w-auto sm:mr-auto" aria-label="horo-scope-sign">
                <ul class="pagination">
                    <li class="page-item <?php echo e($page == 1 ? 'disabled' : ''); ?>">
                        <a class="page-link" href="<?php echo e(route('horoscopeSigns', ['page' => $page - 1])); ?>">
                    ...
                    <?php for($i = 0; $i < $totalPages; $i++): ?>
                        <li class="page-item <?php echo e($page == $i + 1 ? 'active' : ''); ?> ">
                            <a class="page-link"
                                href="<?php echo e(route('horoscopeSigns', ['page' => $i + 1])); ?>"><?php echo e($i + 1); ?></a>
                        </li>
                    <?php endfor; ?>
    ...
    <div id="edit-modal" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('editHororScopeSignApi')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div id="input" class="p-5">
                        <div class="preview">
                            <div class="mt-3">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <form action="<?php echo e(route('horoScopeStatusApi')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        jQuery("#add-data").submit(function(e) {
            ...
            jQuery.ajax({
                type: 'POST',
                url: "<?php echo e(route('addHororScopeSignApi')); ?>",
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/pages/horor-scope-sign-list.blade.php ENDPATH**/ ?>