    ...
    <div class="grid grid-cols-11 gap-x-6 mt-5 pb-20">
        <div class="intro-y col-span-12 2xl:col-span-12">
            <div class="intro-y box">
                ...
                <form action="<?php echo e(route('addProductApi')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/pages/add-product.blade.php ENDPATH**/ ?>