                ...
                <div class="col-md-12 d-flex align-items-center">
                    <span style="text-transform: capitalize; ">
                        <span class="text-white breadcrumbs">
                            ...
                            <i class="fa fa-chevron-right"></i> <a href="<?php echo e(route('front.getkundali')); ?>"
                                                ...
                                                <div class="input-group mb-0">
                                                    ...
                                                    <select
                                                        class="form-control font-14 border-pink text-dark shadow-none matchInTxt"
                                                         name="kundali[0][gender]" requerid >
                                            ...
                                            <?php if($getkundaliprice['isFreeSession'] == false): ?>
                                                <div class="col-12 col-md-6 py-3">
                                                    ...
                                                    <select name="kundali[0][pdf_type]" onchange="updateAmount()"
                                                        ...
                                                        <option value="small"
                                                            data-price="<?php echo e($getkundaliprice['recordList']['SMALL']); ?>">
                                                            Small (<?php echo e($currency['value']); ?><?php echo e($getkundaliprice['recordList']['SMALL']); ?>)</option>
                                                        <option value="medium"
                                                            data-price="<?php echo e($getkundaliprice['recordList']['MEDIUM']); ?>">
                                                            Medium (<?php echo e($currency['value']); ?><?php echo e($getkundaliprice['recordList']['MEDIUM']); ?>)</option>
                                                        <option value="large"
                                                            data-price="<?php echo e($getkundaliprice['recordList']['LARGE']); ?>">
                                                            Large (<?php echo e($currency['value']); ?><?php echo e($getkundaliprice['recordList']['LARGE']); ?>)</option>
                                                    </select>
                                                ...
                                                <?php $__currentLoopData = $getkundali['recordList']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getkundali): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li class="ui-menu-item border-bottom px-3 mt-2">
                                                        <div class="row mb-2">
                                                                    ...
                                                                    <div class="col pl-1">
                                                                        ...
                                                                        class="colorblack">
                                                                            <p
                                                                                ...
                                                                                <?php echo e($getkundali['name']); ?></p>
                                                                            <p class="mb-0 font-12">
                                                                                <?php echo e($getkundali['created_at']); ?></p>
                                                                            <p class="mb-0 font-12">
                                                                                <?php echo e($getkundali['birthPlace']); ?></p>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <!--    <input type="hidden" value="<?php echo e($getkundali['id']); ?>" name="id">-->
                                    ...
                                    <div class="bg-pink looks-1 d-flex p-2 py-3 p-sm-3 overflow-hidden position-relative">
                                        ...
                                        <div
                                            ...
                                            <div class="looks-img-box position-relative"><img
                                                    src="<?php echo e(asset('public/frontend/astrowaycdn/astroway/web/content/images/ads/kundali-dosha-banner.png')); ?>">
                                            </div>
                                        </div>
        ...
        $('#showKundalibtn').click(function(e) {
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    ...
                    toastr.error('Your found is low ..');
                }
            });
        });
    });
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/frontend/pages/kundali.blade.php ENDPATH**/ ?>