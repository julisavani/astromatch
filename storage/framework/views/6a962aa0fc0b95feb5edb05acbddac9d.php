                        ...
                        <div class="container" data-select2-id="select2-data-5-q5pn">
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="off" class="form-control inputtext" id="EmailAddress"
                                            ...
                                            placeholder="Enter Email" type="text" value="<?php echo e($getuserdetails['userDetails']['email']); ?>">
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input autocomplete="off" class="form-control inputtext" data-val="true"
                                                 id="ContactMobile"
                                                maxlength="12" value="<?php echo e($getuserdetails['userDetails']['contactNo']); ?>" name="contactNo"
                                               type="number"
                                                >
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" data-val="true" id="Gender" name="gender">
                                            <option value="" <?php echo e($getuserdetails['userDetails']['gender'] == 0 ? 'selected' : ''); ?>>--Select--</option>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-12">
                                    ...
                                    <input type="date" name="birthDate" class="form-control" value="<?php echo e(date("Y-m-d", strtotime($getuserdetails['userDetails']['birthDate']))); ?>">
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="md-form md-outline input-with-post-icon timepicker position-relative"
                                            default="now">
                                            <input type="time" name="birthTime" class="form-control" value="<?php echo e($getuserdetails['userDetails']['birthTime']); ?>">
                                            <span class="field-validation-valid text-danger" data-valmsg-for="POB"
                                            data-valmsg-replace="true"></span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control inputtext"  id="CurrentAddress" value="<?php echo e($getuserdetails['userDetails']['addressLine1']); ?>" maxlength="300"
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="off" class="form-control inputtext ui-autocomplete-input"
                                            ...
                                            placeholder="Enter Current City" type="text" value="<?php echo e($getuserdetails['userDetails']['location']); ?>">
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="off" class="form-control inputtext" id="PinCode"
                                            ...
                                            placeholder="Enter Pin Code" type="number" value="<?php echo e($getuserdetails['userDetails']['pincode']); ?>">
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/frontend/pages/my-account.blade.php ENDPATH**/ ?>