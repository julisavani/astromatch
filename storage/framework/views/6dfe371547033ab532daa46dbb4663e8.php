        ...
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <div class="intro-y box mt-5" style="width: 100%">
                <div id="boxed-accordion" class="p-5">
                    <div class="preview">
                        <?php $__currentLoopData = $helpSupportSubSubCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="card border p-2 mt-5">
                                <div style="display:inline-block">
                                    <b><?php echo e($subCategory->title); ?></b>
                                    <?php echo $subCategory->description; ?>

                                </div>
                                <div style="float:right">
                                    <a class=" items-center mr-3 text-primary actionbtn" href="javascript:;"
                                        onClick="editHelpSupportSubSubCategory(<?php echo e($subCategory->id); ?>,<?php echo e($subCategory->helpSupportId); ?>,<?php echo e($subCategory->helpSupportQuationId); ?>,'<?php echo e($subCategory->title); ?>',<?php echo e(json_encode($subCategory->description)); ?>,<?php echo e($subCategory->isChatWithus); ?>)"
                                    ...
                                    <a class=" items-center mr-3 text-danger actionbtn" href="javascript:;"
                                        onclick="deleteBtn(<?php echo e($subCategory->id); ?>)" data-tw-toggle="modal"
    ...
    <div id="edit-support" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('editHelpSupportSubSubCategory')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <form action="<?php echo e(route('deleteHelpSupportSubSubCategory')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/pages/help-support-sub-category.blade.php ENDPATH**/ ?>