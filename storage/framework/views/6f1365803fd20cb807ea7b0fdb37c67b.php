...
<?php $__env->startSection('subcontent'); ?>
    ...
    <?php endif; ?>
    <a class="btn btn-primary shadow-md mr-2 mt-10 d-inline addbtn" href="<?php echo e(route('addAstrologer')); ?>">Add Astrologer</a>
                ...
                <tbody id="todo-list">
                    ...
                    <?php $__currentLoopData = $astrologers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $astro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="intro-x">
                            ...
                            <td class="text-center"><?php echo e($astro['email']); ?></td>
        ...
        <nav class="w-full sm:w-auto sm:mr-auto">
            <ul class="pagination">
                ...
                <?php if($startPage > 1): ?>
                    <li class="page-item">
                        <a class="page-link"
                            href="<?php echo e(route('astrologers', ['page' => 1, 'searchString' => $searchString])); ?>">1</a>
                    </li>
                    <?php if($startPage > 2): ?>
                ...
                <?php for($i = $startPage; $i <= $endPage; $i++): ?>
                    <li class="page-item <?php echo e($page == $i ? 'active' : ''); ?>">
                        <a class="page-link"
                            href="<?php echo e(route('astrologers', ['page' => $i, 'searchString' => $searchString])); ?>"><?php echo e($i); ?></a>
                    </li>
                <?php endfor; ?>
                ...
                <?php if($endPage < $totalPages): ?>
                    ...
                    <li class="page-item">
                        <a class="page-link"
                            href="<?php echo e(route('astrologers', ['page' => $totalPages, 'searchString' => $searchString])); ?>"><?php echo e($totalPages); ?></a>
                    </li>
                <?php endif; ?>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/pages/astrologer-list.blade.php ENDPATH**/ ?>