                ...
                <div class="col-md-12 d-flex align-items-center">
                    <span style="text-transform: capitalize; ">
                        <span class="text-white breadcrumbs">
                            ...
                            <i class="fa fa-chevron-right"></i> <a href="<?php echo e(route('front.getproducts')); ?>"
                                    ...
                                    <div class="owl-carousel owl-theme">
                                            <div class="item mb-3" d-flex>
                                                <a href="" class="colorblack">
                                                    <img style="max-height: 300px" src="/<?php echo e($getproductdetails['recordList'][0]['productImage']); ?>" alt="" class="img-fluid" loading="lazy"
                                                      /></a>
                                                <div class="content p-3 bg-white">
                                                    <p class="text-center font-weight-semi font-weight-bold category mb-2"><a
                                                            href="" class="colorblack font-weight-bold"><?php echo e($getproductdetails['recordList'][0]['name']); ?></a>
                                                    </p>


                                                    <div class="text-center pb-1">
                                                        <p><span class="color-red"><?php echo e($currency['value']); ?><?php echo e($getproductdetails['recordList'][0]['amount']); ?></span></p>
                                                        <?php if(!authcheck()): ?>
                                                        <a  role="button" data-toggle="modal"  data-target="#loginSignUp"  class="btn view-more color-red font-weight-normal mb-2">
                                                           Buy Now
                                                        </a>
                                                        <?php else: ?>
                                                        <a href="<?php echo e(route('front.checkout', ['id' => $getproductdetails['recordList'][0]['id']])); ?>" role="button"   class="btn view-more color-red font-weight-normal mb-2">
                                                            Buy Now
                                                         </a>
                                                        <?php endif; ?>
            ...
            <div class="col-md-7">
                <div class="main-description px-2">
                    <div class="category text-bold">
                        Category: <?php echo e($getproductdetails['recordList'][0]['productCategory']); ?>

                    </div>
                    <div class="product-title text-bold my-3">
                        <?php echo e($getproductdetails['recordList'][0]['name']); ?>

                    </div>

                    <div class="price-area my-4">
                        <div class="category text-bold">
                            Price: <?php echo e($currency['value']); ?><?php echo e($getproductdetails['recordList'][0]['amount']); ?>
                    ...
                    <div class="product-details my-4">
                        ...
                        <p class="description"><?php echo e($getproductdetails['recordList'][0]['features']); ?> </p>
                    </div>
                        ...
                        <?php $__currentLoopData = $getAstromallProduct['recordList']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="item mb-3">
                                ...
                                <div class="text-center pb-1">
                                    ...
                                    <a href="<?php echo e(route('front.getproductDetails',['id'=>$shop['id']])); ?>" class="btn view-more color-red font-weight-normal mb-2">
                                       View Details
                                    </a>
                                </div>
                            </div>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/frontend/pages/product-details.blade.php ENDPATH**/ ?>