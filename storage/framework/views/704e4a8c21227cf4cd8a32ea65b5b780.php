                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $gifts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="intro-x">
                            ...
                            <td>
                                <div class="flex">
                                    <div class="w-10 h-10 image-fit zoom-in">
                                        <img class="rounded-full" src="/<?php echo e($gift['image']); ?>"
                            ...
                            <td>
                                <div class="font-medium whitespace-nowrap"><?php echo e($gift['name']); ?></div>
                            </td>

                            <td class="text-center"><?php echo e($currency->value); ?><?php echo e($gift['amount']); ?></td>
                            <td class="w-40">
                                <div
                                 ...
                                 mt-3 sm:mt-0">
                                    ...
                                    <input class="toggle-class show-code form-check-input mr-0 ml-3" type="checkbox"
                                        ...
                                        <?php echo e($gift['isActive'] ? 'checked' : ''); ?>

                                        onclick="editGift(<?php echo e($gift['id']); ?>,'<?php echo e($gift['name']); ?>',<?php echo e($gift['isActive']); ?>)"
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a id="editbtn" href="javascript:;"
                                        onclick="editbtn(<?php echo e($gift['id']); ?> , '<?php echo e($gift['name']); ?>','<?php echo e($gift['image']); ?>', '<?php echo e($gift['amount']); ?>')"
                                    ...
                                    <a id="editbtn" href="javascript:;" onclick="delbtn(<?php echo e($gift['id']); ?>)"
                                        value="<?php echo e($gift['id']); ?>" class="flex items-center text-danger"
            ...
            <nav class="w-full sm:w-auto sm:mr-auto">
                <ul class="pagination">
                    <li class="page-item <?php echo e($page == 1 ? 'disabled' : ''); ?>">
                        <a class="page-link" href="<?php echo e(route('gifts', ['page' => $page - 1])); ?>">
                            <i class="w-4 h-4" data-lucide="chevron-left"></i>
                        </a>
                    </li>
                    <?php for($i = 0; $i < $totalPages; $i++): ?>
                        <li class="page-item <?php echo e($page == $i + 1 ? 'active' : ''); ?> ">
                            <a class="page-link" href="<?php echo e(route('gifts', ['page' => $i + 1])); ?>"><?php echo e($i + 1); ?></a>
                        </li>
                    <?php endfor; ?>
    ...
    <div id="edit-modal" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('editGiftApi')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div id="input" class="p-5">
                        <div class="preview">
                            <div class="mt-3">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <form action="<?php echo e(route('deleteGift')); ?> " method="POST">
                        <?php echo csrf_field(); ?>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        jQuery("#add-data").submit(function(e) {
            ...
            jQuery.ajax({
                type: 'POST',
                url: "<?php echo e(route('addGiftApi')); ?>",
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/pages/gift-list.blade.php ENDPATH**/ ?>