                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="bg-pink mb-2">
                                            ...
                                            <p
                                                ...
                                                Available Balance : <span class="gWalletbalance colorblack"><?php echo e($currency['value']); ?><?php echo e(number_format($getProfile['data']['totalWalletAmount'],2)); ?></span></p>
                                        </div>
                                        ...
                                        <div id="plan-item">
                                            <?php $__currentLoopData = $getRechargeAmount['recordList']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div id="pln-d301" class="pprice ">
                                                    <div class="pdiscount ribbon-top-left"><span> <?php echo e($amount['cashback']); ?>%
                                                            Extra</span></div><button class="btn add-plan w-100"
                                                        id="add-301"><?php echo e($currency['value']); ?><?php echo e($amount['amount']); ?></button>
                                            ...
                                            <div class="col-lg-6 ml-auto">
                                                <div class="row">
                                                    <div class="col-sm-12 pb-2 text-right">
                                                        <img
                                                            src="<?php echo e(asset('public/frontend/astrowaycdn/dashaspeaks/web/content/images/pay-safely.png')); ?>">
                                                    </div>
                                                </div>
                                                <div
                                                                    ...
                                                                    <div class="astroway-calc-section">
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span id="planText" class="w-50 d-flex">Plan
                                                                                ...
                                                                                id="total_plan_amount"><?php echo e($currency['value']); ?><?php echo e(number_format($selectedamount['amount'], 2)); ?></span>
                                                                        </p>
                                                                        ...
                                                                        <p id="gst_details"
                                                                            ...
                                                                            <span class="w-50">
                                                                                <span id="gstval">
                                                                                    <?php echo e($gstvalue['value']); ?></span>% GST(+)
                                                                            </span><span>:</span><span
                                                                                class="w-50 text-right"
                                                                                id="total_plan_gst_amount"><?php echo e($currency['value']); ?><?php echo e(number_format($selectedamount['amount'] * ($gstvalue['value'] / 100), 2)); ?></span>
                                                                        </p>
                                                                        <p
                                                                            class="d-flex justify-content-between align-items-center font-weight-bold border-top">
                                                                            <span
                                                                                class="w-50 ">Total</span><span>:</span><span
                                                                                class="w-50 text-right total_plan_amount_with_gst"><?php echo e($currency['value']); ?><?php echo e(number_format($selectedamount['amount'] + $selectedamount['amount'] * ($gstvalue['value'] / 100), 2)); ?></span>
                                                                        </p>

                                                                        <div class="p-2 align-items-center total-cashback-amount position-relative d-flex"
                                                                            id="total-cashback-amount">
                                                                            <img
                                                                                src="<?php echo e(asset('public/frontend/astrowaycdn/dashaspeaks/web/content/astroway/images/cashback-icon.svg')); ?>">
                                                                            <span class="ml-3">
                                                                                <span class="d-block font-14">
                                                                                    <span id="extracashback"
                                                                                        class="extracashback"> <span
                                                                                            class="font-weight-semi-bold"><span
                                                                                                id="total_plan_cashback_percent"><?php echo e($selectedamount['cashback']); ?>%
                                                                                                Extra</span></span></span>
                                                                                </span>
                                                                                <span class="d-block font-12">
                                                                                    <span
                                                                                        id="total_plan_cashback_amount"><?php echo e($currency['value']); ?><?php echo e(number_format(($selectedamount['amount'] * $selectedamount['cashback']) / 100, 2)); ?>
                                                                        ...
                                                                        <div class="astroway-astro-plan-calc-right">
                                                                            <div
                                                                                ...
                                                                                <input type="button" class="btn btn-block" id="proceedbtn" value="Proceed To Pay <?php echo e($currency['value']); ?><?php echo e(number_format($selectedamount['amount'] + $selectedamount['amount'] * ($gstvalue['value'] / 100), 2)); ?>">
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/frontend/pages/wallet-recharge.blade.php ENDPATH**/ ?>