    ...
    <script type="text/javascript">
        ...
        jQuery(function() {
            jQuery('#add-form').submit(function(e) {
                ...
                jQuery.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('addUserApi')); ?>",
                    data: data,
                    dataType: 'JSON',
                    processData: false,
                    contentType: false,
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/pages/add-customer.blade.php ENDPATH**/ ?>