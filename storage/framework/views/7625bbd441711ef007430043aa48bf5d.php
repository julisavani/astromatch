                            ...
                            <li class="taurus">
                                <a href="<?php echo e(route('front.dailyHoroscope', ['horoscopeSignId' => $horoscopesign['id']])); ?>"
                                    ...
                                    <div class="text-center mb-2 mb-md-0">
                                        ...
                                        <span class="d-block icon-desc pt-0"><?php echo e($horoscopesign['name']); ?></span>
                                    </div>
                                </a>
                            </li>
                                ...
                                <div class="w-100">
                                    <div class="pt-0 mb-1">
                                        ...
                                        <a class="btn m-1 bg-white color-red border-red font-14 font-weight-semi-bold titlecase rounded-25 px-md-4 hover-border-red"
                                            ...
                                            <span class="d-none d-md-inline-block"><?php echo e(date('Y')); ?></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-content">
                            <div class="col-12 pt-4 mt-3 tab-pane fade show active" id="dailyData">
                                <h2 class="cat-heading mb-4">Free <span
                                    class="color-red"><?php echo e($horoscope['vedicList']['todayHoroscope'][0]['zodiac']); ?></span> Daily
                                Horoscope, <?php echo e($horoscope['vedicList']['todayHoroscope'][0]['date']); ?>

                            </h2>
                                <div class="d-md-flex align-items-start" >
                                    <img src="/<?php echo e($signRcd[0]->image); ?>" style="max-height: 140px"
                                        class="mr-md-3 mx-auto d-block" alt="Aries">
                                    <div class="media-body">
                                        <div class="dailyhoroscope-content mt-3">
                                            <p>Free <?php echo e($horoscope['vedicList']['todayHoroscope'][0]['zodiac']); ?> Daily
                                                Horoscope
                                            </p>
                                            <p> <?php echo e($horoscope['vedicList']['todayHoroscope'][0]['bot_response']); ?></p>
                                        </div>
                                        ...
                                        <div class="shadow-pink rounded-10">
                                            <div class="bg-pink">
                                                <h3 class="text-center font-weight-bold color-red py-2">Today’s Lucky Color
                                                    and
                                                    Number For <?php echo e($horoscope['vedicList']['todayHoroscope'][0]['zodiac']); ?>
                                            ...
                                            <div class="px-3">
                                                <div class="row">
                                                    <div class="col-md-6 text-center">
                                                        ...
                                                        <p><?php echo e($horoscope['vedicList']['todayHoroscope'][0]['zodiac']); ?>

                                                            Lucky
                                                            Color For Today
                                                            <br><strong><?php echo e($horoscope['vedicList']['todayHoroscope'][0]['lucky_color']); ?></strong>
                                                        </p>
                                                    </div>
                                                    <div class="col-md-6 text-center">
                                                        ...
                                                        <p><?php echo e($horoscope['vedicList']['todayHoroscope'][0]['zodiac']); ?>
                                                            ...
                                                            Lucky
                                                            Number For Today
                                                            <br><strong><?php echo e($horoscope['vedicList']['todayHoroscope'][0]['lucky_number']); ?></strong>
                                                        </p>
                                                    </div>
                            ...
                            <div class="col-12 pt-4 mt-3 tab-pane fade" id="weeklyData">
                                <h2 class="cat-heading mb-4">Free <span
                                    class="color-red"><?php echo e($horoscope['vedicList']['weeklyHoroScope'][0]['zodiac']); ?></span> Weekly
                                Horoscope, <?php echo e($horoscope['vedicList']['weeklyHoroScope'][0]['start_date']); ?> To <?php echo e($horoscope['vedicList']['weeklyHoroScope'][0]['end_date']); ?>
                                ...
                                <div class="d-md-flex align-items-start " >
                                    ...
                                    <div class="media-body">
                                        <div class="dailyhoroscope-content mt-3">
                                            <p>Free <?php echo e($horoscope['vedicList']['weeklyHoroScope'][0]['zodiac']); ?> Weekly
                                                Horoscope
                                            </p>
                                            <p> <?php echo e($horoscope['vedicList']['weeklyHoroScope'][0]['bot_response']); ?></p>
                                        </div>

                                        <div class="shadow-pink rounded-10">
                                            <div class="bg-pink">
                                                <h3 class="text-center font-weight-bold color-red py-2">Weekly's Lucky Color
                                                    and
                                                    Number For <?php echo e($horoscope['vedicList']['weeklyHoroScope'][0]['zodiac']); ?>
                                            ...
                                            <div class="px-3">
                                                <div class="row">
                                                    <div class="col-md-6 text-center">
                                                        ...
                                                        <p><?php echo e($horoscope['vedicList']['weeklyHoroScope'][0]['zodiac']); ?>

                                                            Lucky
                                                            Color For week
                                                            <br><strong><?php echo e($horoscope['vedicList']['weeklyHoroScope'][0]['lucky_color']); ?></strong>
                                                        </p>
                                                    </div>
                                                    <div class="col-md-6 text-center">
                                                        <div class="my-3"><svg data-name="Group 31029"
                                                        ...
                                                        <p><?php echo e($horoscope['vedicList']['weeklyHoroScope'][0]['zodiac']); ?>
                                                            ...
                                                            Lucky
                                                            Number For Week
                                                            <br><strong><?php echo e($horoscope['vedicList']['weeklyHoroScope'][0]['lucky_number']); ?></strong>
                                                        </p>
                                                    </div>
                            ...
                            <div class="col-12 pt-4 mt-3 tab-pane fade " id="yearlyData">
                                <h2 class="cat-heading mb-4">Free <span
                                    class="color-red"><?php echo e($horoscope['vedicList']['todayHoroscope'][0]['zodiac']); ?></span> Yearly
                                Horoscope, <?php echo e(date('Y')); ?>
                                ...
                                <div class="d-md-flex align-items-start ">
                                    ...
                                    <div class="media-body">
                                        <div class="dailyhoroscope-content mt-3">
                                            <p>Free <?php echo e($horoscope['vedicList']['yearlyHoroScope'][0]['zodiac'] ?? ""); ?> Yearly
                                                Horoscope
                                            </p>
                                            <p> <?php echo e($horoscope['vedicList']['yearlyHoroScope'][0]['bot_response'] ?? ""); ?></p>
                                            <p>Health Remark :</p><p> <?php echo e($horoscope['vedicList']['yearlyHoroScope'][0]['health_remark'] ?? ""); ?></p>
                                            <p>Relationship Remark :</p><p> <?php echo e($horoscope['vedicList']['yearlyHoroScope'][0]['relationship_remark'] ?? ""); ?></p>
                                            <p>Travel Remark :</p><p> <?php echo e($horoscope['vedicList']['yearlyHoroScope'][0]['travel_remark'] ?? ""); ?></p>
                                            <p>Family Remark :</p><p> <?php echo e($horoscope['vedicList']['yearlyHoroScope'][0]['family_remark'] ?? ""); ?></p>
                                            <p>Friends Remark :</p><p> <?php echo e($horoscope['vedicList']['yearlyHoroScope'][0]['friends_remark'] ?? ""); ?></p>
                                            <p>Finances Remark :</p><p> <?php echo e($horoscope['vedicList']['yearlyHoroScope'][0]['finances_remark'] ?? ""); ?></p>
                                            <p>Status Remark :</p><p> <?php echo e($horoscope['vedicList']['yearlyHoroScope'][0]['status_remark'] ?? ""); ?></p>
                                        </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="looks-img-box position-relative">
                                <img
                                    src="<?php echo e(asset('public/frontend/astrowaycdn/astroway/web/content/images/ads/success-future.png')); ?>">
                            </div>
                        </div>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/frontend/pages/dailyhoroscope.blade.php ENDPATH**/ ?>