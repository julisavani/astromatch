                        ...
                        <div class="col-4 col-md-4 col-lg-3 col-xl-2 mb-4">
                            <div class="shadow-pink-down text-center p-3 hover-border-red rounded-10">
                                <a href="<?php echo e(route('front.dailyHoroscope',['horoscopeSignId' => $horoscopesign['id']])); ?>"
                                    title="<?php echo e($horoscopesign['name']); ?>" class="text-decoration-none text-dark">
                                    <div>
                                        <img style="height: 110px;width:110px" src="/<?php echo e($horoscopesign['image']); ?>"
                                            alt="<?php echo e($horoscopesign['name']); ?>">

                                    </div>
                                    <div class="">
                                        <p class="font-weight-bold mb-0 mt-2 color-red"><?php echo e($horoscopesign['name']); ?></p>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/frontend/pages/horoscopesign.blade.php ENDPATH**/ ?>