                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $withdrawlRequest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="intro-x">
                            ...
                            <td>
                                <?php echo e($request->method_name); ?>

                            </td>
                            <td>
                                <?php if($request->method_id == 2): ?>
                                    UPI:<?php echo e($request->upiId); ?>

                                <?php elseif($request->method_id == 3): ?>
                                    --
                                <?php else: ?>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/pages/withdrawl.blade.php ENDPATH**/ ?>