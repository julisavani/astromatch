            ...
            <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                <form action="<?php echo e(route('blogs')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="w-56 relative text-slate-500" style="display:inline-block">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('blogs')); ?>"><i class="w-4 h-4 absolute my-auto inset-y-0 mr-3 right-0"
                                    data-lucide="x"></i></a>
                        <?php endif; ?>
                    </div>
            ...
            <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="intro-y col-span-12 md:col-span-6 box">
                    <div
                        ...
                        <?php if($blog->extension == 'jpg' || $blog->extension == 'jpeg' || $blog->extension == 'gif' || $blog->extension == 'png'): ?>
                            <img alt="Blog image" class="rounded-t-md" src="/<?php echo e($blog['blogImage']); ?>">
                        <?php else: ?>
                            <video controls style="height:100%;width:100%;object-fit:cover;position:absolute;z-index:10">
                                <source src="/<?php echo e($blog['blogImage']); ?>" type="video/mp4">
                                <track label="English" kind="subtitles" srclang="en" default />
                            </video>
                        <?php endif; ?>
                        <div class="absolute w-full flex items-center px-5 pt-6 z-10">
                            <div class="ml-3 text-white mr-auto">
                                <a href="" class="font-medium"><?php echo e($blog['author']); ?></a>
                                <div class="text-xs mt-0.5">
                                    <?php if($blog['postedOn']): ?>
                                        <?php echo e(date('d-m-Y', strtotime($blog['postedOn']))); ?>
                            ...
                            <div class="dropdown ml-3">
                                ...
                                <div class="dropdown-menu w-40">
                                    <ul class="dropdown-content">
                                        <li>
                                            <a href="<?php echo e(route('getBlogById', $blog['id'])); ?>" class="dropdown-item">
                                                <i data-lucide="eye" class="w-4 h-4 mr-2"></i> View Blog
                                            </a>
                                        </li>
                                        <li>
                                            <a id="editbtn" href="javascript:;"
                                                onclick="editbtn(<?php echo e($blog['id']); ?>,'<?php echo e($blog['title']); ?>', '<?php echo e($blog['postedOn']); ?>','<?php echo e($blog['author']); ?>',<?php echo e(json_encode($blog['description'])); ?>,'<?php echo e($blog['blogImage']); ?>','<?php echo e($blog['extension']); ?>','<?php echo e($blog['previewImage']); ?>')"
                                        ...
                                        <li>
                                            <a id="editbtn" href="javascript:;" onclick="deletebtn(<?php echo e($blog['id']); ?>)"
                    ...
                    <div class="px-5 pt-5 text-slate-600 dark:text-slate-500">
                        <h2 class="font-medium text-xl"><?php echo e($blog['title']); ?></h2>
                    </div>
                    <div class="p-5 text-slate-600 dark:text-slate-500"><?php echo $blog['description']; ?></div>
                    <div
                        ...
                        <div class="w-full flex text-slate-500 text-xs sm:text-sm">
                            ...
                            <div class="mr-2">
                                Views: <span class="font-medium"><?php echo e($blog['viewer'] ? $blog['viewer'] : '0'); ?></span>
                            </div>
                        </div>
                        <div
                    ...
                    mt-3 sm:mt-0">
                            <input class="toggle-class show-code form-check-input mr-0 ml-3" type="checkbox"
                                ...
                                <?php echo e($blog['isActive'] ? 'checked' : ''); ?>

                                onclick="editBlogStatus(<?php echo e($blog['id']); ?>,<?php echo e($blog['isActive']); ?>)" href="$blog['id']"
            ...
            <nav class="w-full sm:w-auto sm:mr-auto">
                <ul class="pagination">
                    <li class="page-item <?php echo e($page == 1 ? 'disabled' : ''); ?>">
                        <a class="page-link"
                            href="<?php echo e(route('blogs', ['page' => $page - 1, 'searchString' => $searchString])); ?>">
                    ...
                    <?php for($i = 0; $i < $totalPages; $i++): ?>
                        <li class="page-item <?php echo e($page == $i + 1 ? 'active' : ''); ?> ">
                            <a class="page-link"
                                href="<?php echo e(route('blogs', ['page' => $i + 1, 'searchString' => $searchString])); ?>"><?php echo e($i + 1); ?></a>
                        </li>
                    <?php endfor; ?>
                        ...
                        <div class="preview">
                            <div class="mt-3">
                                <div class="sm:grid grid-cols gap-2">
                                    <div class="input">
                                        <div>
                                            ...
                                            <input type="text" name="title" id="title" class="form-control"
                                                placeholder="Title"  onkeypress="return Validate(event);">
                                    ...
                                    <div class="mt-3">
                                        <div class="sm:grid grid-cols-2 gap-2">
                                            <div class="input mt-2 sm:mt-0">
                                                ...
                                                <span id="error_postedOn" class="text-danger"></span>
                                                </div>
                                            </div>
                                            <div class="input mt-2 sm:mt-0">
                                                <div>
                                        ...
                                        <div class="input mt-2">
                                            <div>
                                                ...
                                                <input type="file" name="blogImage" id="blogImage"
                                                    onchange="preview()"  accept="video/mp4,image/*">
                                                <span id="error_blogImage" class="text-danger"></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-5"><button type="button" id="addsubmit" class="btn btn-primary shadow-md mr-2">Add
                                            Blog</button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="input" class="p-5">
                        <div class="preview">
                                ...
                                <div class="sm:grid grid-cols gap-2">
                                    <div class="input">
                                        <div>
                                            ...
                                            <span id="error_etitle" class="text-danger"></span>
                                        </div>
                                    </div>
                                    <div class="mt-3">
                                        <div class="sm:grid grid-cols-2 gap-2">
                                            ...
                                            <div class="input mt-2 sm:mt-0">
                                                <div>
                                                    ...
                                                    <input type="date" id="epostedOn" name="postedOn"
                                                        class="form-control" placeholder="PostedOn"
                                                        aria-describedby="input-group-3" >
                                                    <span id="error_epostedOn" class="text-danger"></span>
                                                </div>
                                            </div>
                                            <div class="input mt-2 sm:mt-0">
                                                <div>
                                                    ...
                                                    <input type="text" name="author" id="eauthor"
                                                        class="form-control" placeholder="Posted By" 
                                                        onkeypress="return Validate(event);">
                                                        <span id="error_eauthor" class="text-danger"></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="input" id="classic-editor">
                                        ...
                                        <span id="error_editdescription" class="text-danger"></span>
                                    </div>
                                    <div class="input mt-2">
                                        <div>
                                            <label for="image" class="form-label">Preview Image</label>
                            ...
                            <div class="mt-5"><button
                                    type="button" id="editsubmit" class="btn btn-primary shadow-md mr-2">Save</button>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <form action="<?php echo e(route('blogStatusApi')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script type="text/javascript">
        ...
        jQuery('#editsubmit').click( function() {
                ...
                var descrip=CKEDITOR.instances['editdescription'].getData();
                $('#editdescription').val(descrip);
                $('#error_etitle').text('');
                $('#error_epostedOn').text('');
                $('#error_eauthor').text('');
                $('#error_editdescription').text('');
                var etitle = $('#etitle').val();
                var epostedOn = $('#epostedOn').val();
                var eauthor = $('#eauthor').val();
                var edescription = $('#editdescription').val();
                console.log(edescription);
                if(etitle == ""){
                     $('#error_etitle').text('Please enter title');
                     return false;
                }
                if(epostedOn == ""){
                     $('#error_epostedOn').text('Please enter posted on');
                     return false;
                }
               
                if(eauthor == ""){
                     $('#error_eauthor').text('Please enter author');
                     return false;
                }
                if(edescription == ""){
                     $('#error_editdescription').text('Please enter description');
                     return false;
                }
                spinner.show();
                jQuery.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('editBlogApi')); ?>",
                    data: data,
                    dataType: 'JSON',
                    processData: false,
                    contentType: false,
        ...
        jQuery('#addsubmit').click( function() {
                ...
                if(postedOn == ""){
                     $('#error_postedOn').text('Please enter posted on');
                     return false;
                }
                if(author == ""){
                     $('#error_author').text('Please enter author');
                     return false;
                }
                if(blogImage == ""){
                     $('#error_blogImage').text('Please set blog image');
                     return false;
                }
                if(description == ""){
                ...
                jQuery.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('addBlogApi')); ?>",
                    data: data,
                    dataType: 'JSON',
                    processData: false,
                    contentType: false,
        ...
        //         }
        //         if(edescription == ""){
        //              $('#error_edescription').text('Please enter description');
        //              return false;
        //         }
        //         spinner.show();
        //         jQuery.ajax({
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/pages/blog-list.blade.php ENDPATH**/ ?>