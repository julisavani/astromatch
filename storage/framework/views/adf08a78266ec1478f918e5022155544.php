                ...
                <div class="col-md-12 d-flex align-items-center">
                    <span style="text-transform: capitalize; ">
                        <span class="text-white breadcrumbs">
                            ...
                            <i class="fa fa-chevron-right"></i> <a href="<?php echo e(route('front.checkout')); ?>"
                                    ...
                                    <div class="table-responsive  mt-4 mb-4 ">
                                        <table class="table  border-pink font-14 mb-0 text-center">
                                            <tbody>
                                                ...
                                                <?php $__currentLoopData = $getOrderAddress['recordList']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getOrderAddress): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td> <input type="radio" name="orderAddressId"
                                                                value="<?php echo e($getOrderAddress['id']); ?>"></td>
                                                        <td><?php echo e($getOrderAddress['name']); ?></td>
                                                        <td><?php echo e($getOrderAddress['phoneNumber']); ?></td>
                                                        <td><?php echo e($getOrderAddress['flatNo']); ?>,<?php echo e($getOrderAddress['locality']); ?>,<?php echo e($getOrderAddress['landmark']); ?>,<?php echo e($getOrderAddress['city']); ?>,<?php echo e($getOrderAddress['state']); ?>,<?php echo e($getOrderAddress['country']); ?>,<?php echo e($getOrderAddress['pincode']); ?>
                                    ...
                                    <div class="card-body pt-0">
                                            ...
                                            <div class="col-auto">
                                                <div class="media">
                                                    <img class="img-fluid mr-3"
                                                        src="/<?php echo e($getproductdetails['recordList'][0]['productImage']); ?>"
                                                        width="62" height="62">
                                                    <div class="media-body">
                                                        <p class="mb-0">
                                                            <b><?php echo e($getproductdetails['recordList'][0]['name']); ?></b></p>
                                                        <small
                                                            class="text-muted"><?php echo e($getproductdetails['recordList'][0]['features']); ?></small>
                                                    </div>
                                                </div>
                                            </div>
                                            <input type="hidden" name="productCategoryId"
                                                value="<?php echo e($getproductdetails['recordList'][0]['productCategoryId']); ?>">
                                            <input type="hidden" name="productId"
                                                value="<?php echo e($getproductdetails['recordList'][0]['id']); ?>">
                                        ...
                                        <div class="row justify-content-between ">
                                            ...
                                            <div class="col-auto my-auto">
                                                <p><span><?php echo e($currency['value']); ?><?php echo e(number_format($getproductdetails['recordList'][0]['amount'], 2)); ?></span>
                                                </p>
                                                <input type="hidden"
                                                    value="<?php echo e(number_format($getproductdetails['recordList'][0]['amount'], 2)); ?>"
                                                    name="payableAmount">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row justify-content-between">
                                            <div class="col-auto">
                                                <p><span>Gst( <?php echo e($gstvalue['value']); ?>%):</span></p>
                                            </div>
                                            <div class="col-auto my-auto">
                                                <p><span><?php echo e($currency['value']); ?><?php echo e(number_format($getproductdetails['recordList'][0]['amount'] * ($gstvalue['value'] / 100), 2)); ?></span>
                                                </p>
                                                <input type="hidden" value="<?php echo e($gstvalue['value']); ?>"
                                                    name="gstPercent">
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row justify-content-between mb-2">
                                            ...
                                            <div class="col-auto my-auto color-red">
                                                <p><b><?php echo e($currency['value']); ?><?php echo e(number_format($getproductdetails['recordList'][0]['amount'] + $getproductdetails['recordList'][0]['amount'] * ($gstvalue['value'] / 100), 2)); ?></b>
                                                </p>
                                                <input type="hidden"
                                                    value="<?php echo e(number_format($getproductdetails['recordList'][0]['amount'] + $getproductdetails['recordList'][0]['amount'] * ($gstvalue['value'] / 100), 2)); ?>"
    ...
    <script>
        $(document).ready(function() {
            $('#addressBtn').click(function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route('api.addOrderAddress', ['token' => $token])); ?>',
                    type: 'POST',
                    data: formData,
    ...
    <script>
        $(document).ready(function() {
            $('#orderBtn').click(function(e) {
                ...
                var walletamount="<?php echo e($wallet->amount); ?>"
                ...
                $.ajax({
                    url: '<?php echo e(route('api.addUserOrder', ['token' => $token])); ?>',
                    type: 'POST',
                    data: formData,
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/frontend/pages/checkout.blade.php ENDPATH**/ ?>