...
<?php $__env->startSection('subcontent'); ?>
            ...
            <table class="table table-report -mt-2" aria-label="astrologer-category">
                ...
                <tbody>
                    <?php
                        $no = 0;
                    ?>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $astroCat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="intro-x">
                            <td><?php echo e(($page - 1) * 15 + ++$no); ?></td>
                            <td>
                                <div class="flex">
                                    <div class="w-10 h-10 image-fit zoom-in">
                                        <img class="rounded-full" src="/<?php echo e($astroCat['image']); ?>"
                            ...
                            <td>
                                <div class="font-medium whitespace-nowrap"><?php echo e($astroCat['name']); ?></div>
                            </td>
                                ...
                                <div
                                 ...
                                 mt-3 sm:mt-0">
                                    <input class="toggle-class show-code form-check-input mr-0 ml-3" type="checkbox"
                                        ...
                                        <?php echo e($astroCat['isActive'] ? 'checked' : ''); ?>

                                        onclick="editAstrologyCategory(<?php echo e($astroCat['id']); ?>,<?php echo e($astroCat['isActive']); ?>)"
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a id="editbtn" href="javascript:;"
                                        onclick="editbtn(<?php echo e($astroCat['id']); ?> , '<?php echo e($astroCat['name']); ?>','<?php echo e($astroCat['image']); ?>')"
            ...
            <nav class="w-full sm:w-auto sm:mr-auto">
                <ul class="pagination">
                    <li class="page-item <?php echo e($page == 1 ? 'disabled' : ''); ?>">
                        <a class="page-link" href="<?php echo e(route('astrologerCategories', ['page' => $page - 1])); ?>">
                    ...
                    <?php for($i = 0; $i < $totalPages; $i++): ?>
                        <li class="page-item <?php echo e($page == $i + 1 ? 'active' : ''); ?> ">
                            <a class="page-link"
                                href="<?php echo e(route('astrologerCategories', ['page' => $i + 1])); ?>"><?php echo e($i + 1); ?></a>
                        </li>
                    <?php endfor; ?>
    ...
    <div id="edit-modal" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" enctype="multipart/form-data" action="<?php echo e(route('editAstrologerCategory')); ?>">
                    <?php echo csrf_field(); ?>
                    <div id="input" class="p-5">
                        <div class="preview">
                            <div class="mt-3">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <form action="<?php echo e(route('astrologyCategoryStatusApi')); ?>" method="POST"
    ...
    jQuery("#add-data").submit(function(e) {
            ...
            jQuery.ajax({
                type: 'POST',
                url: "<?php echo e(route('addAstrolgerCategoryApi')); ?>",
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/pages/astrologer-category-list.blade.php ENDPATH**/ ?>