            ...
            <table class="table table-report mt-2" aria-label="customer-list">
                ...
                <tbody id="todo-list">
                    <?php
                        $no = 0;
                    ?>
                    <?php $__currentLoopData = $customerProfile; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="intro-x">
                            <td><?php echo e(($page - 1) * 15 + ++$no); ?></td>
                            <td>
                                <div class="flex">
                                    <div class="w-10 h-10 image-fit zoom-in">
                                        <img class="rounded-full" src="/<?php echo e($profile->profile); ?>"
                            ...
                            <td>
                                <div class="font-medium whitespace-nowrap"><?php echo e($profile->name ? $profile->name : '--'); ?>
                                ...
                                <div
                                 ...
                                 mt-3 sm:mt-0">
                                    <input class="toggle-class show-code form-check-input mr-0 ml-3" type="checkbox"
                                        ...
                                        <?php echo e($profile->isActive ? 'checked' : ''); ?>

                                        onclick="changeStatus(<?php echo e($profile->id); ?>,<?php echo e($profile->isActive); ?>)"
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a data-tw-toggle="modal" data-tw-target="#edit-modal" href="javascript:;"
                                        ...
                                        onclick="editbtn(<?php echo e($profile->id); ?>,'<?php echo e($profile->name); ?>','<?php echo e($profile->profile); ?>')">
    ...
    <div id="edit-modal" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('editCustomerProfile')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div id="input" class="p-5">
                        <div class="preview">
                            <div class="mt-3">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <form action="<?php echo e(route('customerProfileApi')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        jQuery("#add-data").submit(function(e) {
            ...
            jQuery.ajax({
                type: 'POST',
                url: "<?php echo e(route('addDefaultProfile')); ?>",
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/pages/default-profile.blade.php ENDPATH**/ ?>