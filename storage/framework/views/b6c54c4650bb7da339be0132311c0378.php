        ...
        <div class="col-12 contactbox align-self-center text-center" style="margin-top :0!important">
            ...
            <div class="row pt-3 pt-md-5 justify-content-between inpage mt-4">
                <div class="col-12 col-md-6 text-left">
                    <h2 class="font22 weight500"><?php echo $appName->value; ?></h2>
                    ...
                    <p class="font14 mb-1"><i class="fa fa-headphones mr-1 font16"></i> Customer Support:
                        <?php echo $sitenumber; ?></p>
                    <p class="font14"><i class="fa fa-envelope mr-1 font16"></i> <a
                            href="mailto:support@anytimeastro.com" class="colorblack font14"><?php echo $siteemail; ?></a></p>
                </div>
                ...
                <div class="col-12 col-md-6 pt-5 pt-md-0  text-left">
                    ...
                    <form id="contactform" method="post" action="<?php echo e(route('front.store.contact')); ?>" novalidate>
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/frontend/pages/contact.blade.php ENDPATH**/ ?>