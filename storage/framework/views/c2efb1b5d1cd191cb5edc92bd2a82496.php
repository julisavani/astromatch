<?php $__env->startSection('content'); ?>
    ...
    <div class="ds-head-body">
        ...
        <div class="container mt-3">
            ...
            <div class="slider">
                <!-- slide 1 -->
                <?php $__currentLoopData = $home_data['banner']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banners): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="slide">
                        <img src="/<?php echo e($banners['bannerImage']); ?>" alt="" />
                    </div>
                        ...
                        <ul class="list-unstyled d-flex mb-0 px-lg-4 px-xl-5 mx-xl-5 pt-3 pb-lg-3">
                            ...
                            <li class="Online-Puja">
                                <a href="<?php echo e(route('front.getproducts')); ?>">
                                    <div class="text-center mb-2 mb-md-0">
                                        <div class="icon">
                                            <img src="/<?php echo e($shop['value']); ?>" alt="" height="55" width="55">
                                        </div>
                            ...
                            <li class="astroway-blog mr-0">
                                <a href="<?php echo e(route('front.getBlog')); ?>">
                                    <div class="text-center mb-2 mb-md-0">
                                        <div class="icon">
                                            <img src="/<?php echo e($blog['value']); ?>" alt="" height="55" width="55">
                                        </div>
                        ...
                        <div class="owl-carousel owl-theme owl-blur owl-mobile">
                            ...
                            <?php $__currentLoopData = $getAstrologer['recordList']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $astrologer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="item p-3 mb-3 expertOnline bg-white"
                                    data-psychic-id="<?php echo e($astrologer['id']); ?>">
                                    <a href="<?php echo e(route('front.astrologerDetails', ['id' => $astrologer['id']])); ?>">
                                        <div class="psychic-presence status-<?php echo e($astrologer['id']); ?>" data-status="Online"
                                            data-psychic-id="<?php echo e($astrologer['id']); ?>">
                                            <div id="psychic-<?php echo e($astrologer['id']); ?>-badge"
                                        ...
                                        <div class="astro-profile">
                                            <div>
                                                <?php if($astrologer['profileImage']): ?>
                                                    <img src="/<?php echo e($astrologer['profileImage']); ?>" class="img-fluid"
                                                        loading="lazy">
                                                <?php else: ?>
                                                    <img src="<?php echo e(asset('public/frontend/astrowaycdn/dashaspeaks/web/content/images/user-img-new.png')); ?>"
                                                        class="img-fluid">
                                            ...
                                            <p class="astro-name text-center colorblack text-capitalize"
                                                data-toggle="tooltip" title="<?php echo e($astrologer['name']); ?>"
                                                style="white-space: nowrap;text-overflow: ellipsis;display: block;overflow:hidden">
                                                <?php echo e($astrologer['name']); ?></p>
                                        </div>
                                        <div>
                                            <p class="mb-0 colorblack text-center">Reviews: <span
                                                    class="color-red"><?php echo e($astrologer['reviews']); ?></span></p>
                ...
                <div class="row pt-md-3">
                    <div class="col-sm-12">
                        <div class="owl-carousel owl-theme owl-youtube">
                            ...
                            <?php $__currentLoopData = $home_data['astrologyVideo']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $astrologyVideo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e($astrologyVideo['youtubeLink']); ?>">
                                    <div class="tile">
                                        <div
                                            ...
                                            <img style="cursor: pointer;" class="position-absolute youtube-icon w-auto"
                                                src="<?php echo e(asset('public/frontend/astrowaycdn/dashaspeaks/web/content/astroway/images/youtube.svg')); ?>"
                                                alt="">

                                            <img class="youtube-image" src="/<?php echo e($astrologyVideo['coverImage']); ?>"
                                                alt="">

                                        </div>
                                        <p class="text-center text-center m-2 fw-bold"><?php echo e($astrologyVideo['videoTitle']); ?>
                            ...
                            <?php $__currentLoopData = $getAstromallProduct['recordList']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="item mb-3">
                                    <a href="<?php echo e(route('front.getproductDetails', ['id' => $shop['id']])); ?>">
                                        <img src="/<?php echo e($shop['productImage']); ?>" alt="<?php echo e($shop['name']); ?>"
                                    ...
                                    <div class="text-center pb-1">
                                        <p><span class="color-red"><?php echo e($currency['value']); ?><?php echo e($shop['amount']); ?></span>
                                        </p>
                                        <a href="<?php echo e(route('front.getproductDetails', ['id' => $shop['id']])); ?>"
                        ...
                        <div class="d-flex flex-wrap justify-content-center publishers-list">
                            ...
                            <?php $__currentLoopData = $home_data['astrotalkInNews']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $astrotalkInNews): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e($astrotalkInNews['link']); ?>" target="_blank">
                                    <div class="publisher row-1"><img src="/<?php echo e($astrotalkInNews['bannerImage']); ?>"
        ...
        <div class="astroway-blog py-4 py-md-5">
            <div class="container">
                <div class="row pb-2">
                    <div class="col-sm-12">
                        <h2 class="text-md-center heading">
                            OUR BLOG <a href="<?php echo e(route('front.getBlog')); ?>" class="float-right d-md-none">
                ...
                <div class="row pt-md-3">
                    <div class="col-sm-12">
                        <div class="owl-carousel owl-theme">
                            <?php $__currentLoopData = $home_data['blog']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="item mb-3" d-flex>
                                    <a href="<?php echo e(route('front.getBlogDetails', ['id' => $blog['id']])); ?>"
                                        class="colorblack">
                                        <img src="/<?php echo e($blog['blogImage']); ?>" alt="" class="img-fluid"
                                    ...
                                    <div class="content p-3 bg-white">
                                        <p class="text-center font-weight-semi font-weight-bold category mb-2"><a
                                                href="<?php echo e(route('front.getBlogDetails', ['id' => $blog['id']])); ?>"
                                                class="colorblack font-weight-bold"><?php echo e($blog['title']); ?></a>
                                        </p>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/frontend/pages/index.blade.php ENDPATH**/ ?>