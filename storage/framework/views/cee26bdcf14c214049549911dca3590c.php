                    ...
                    <?php $__currentLoopData = $rechargeAmount; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="intro-x">
                            ...
                            <td>
                                ...
                                <div class="font-medium whitespace-nowrap"><?php echo e($item->amount); ?>
                            ...
                            <td>
                                ...
                                <div class="font-medium whitespace-nowrap"> <?php echo e($item->cashback ? $item->cashback . '%' : '---'); ?>
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    ...
                                    onclick="editbtn(<?php echo e($item->id); ?> , '<?php echo e($item->amount); ?>', '<?php echo e($item->cashback); ?>')"
    ...
    <div id="edit-skill" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div id="form-validation" class="p-5">
                    <div class="preview">
                        <form action="<?php echo e(route('editRechargeAmount')); ?>" method="POST" enctype="multipart/form-data"
                            id="edit-form">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/pages/recharge-amount.blade.php ENDPATH**/ ?>