                                ...
                                <div
                                 ...
                                 mt-3 sm:mt-0">
                                    <input class="toggle-class show-code form-check-input mr-0 ml-3" type="checkbox"
                                        ...
                                        <?php echo e($item['isActive'] ? 'checked' : ''); ?>

                                        onclick="editSkill(<?php echo e($item['id']); ?>,'<?php echo e($item['name']); ?>',<?php echo e($item['isActive']); ?>)"
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a id="editbtn" href="javascript:;"
                                        onclick="editbtn(<?php echo e($item['id']); ?> , '<?php echo e($item['name']); ?>')"
                                        value="<?php echo e($item['name']); ?>" class="flex items-center mr-3 "
    ...
    <div id="edit-modal" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('editSkillApi')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
            ...
            <nav class="w-full sm:w-auto sm:mr-auto">
                <ul class="pagination">
                    <li class="page-item <?php echo e($page == 1 ? 'disabled' : ''); ?>">
                        <a class="page-link" href="<?php echo e(route('skills', ['page' => $page - 1])); ?>">
                    ...
                    <?php for($i = 0; $i < $totalPages; $i++): ?>
                        <li class="page-item <?php echo e($page == $i + 1 ? 'active' : ''); ?> ">
                            <a class="page-link"
                                href="<?php echo e(route('skills', ['page' => $i + 1])); ?>"><?php echo e($i + 1); ?></a>
                        </li>
                    <?php endfor; ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <form action="<?php echo e(route('deleteSkill')); ?> " method="POST">
                        <?php echo csrf_field(); ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <form action="<?php echo e(route('skillStatusApi')); ?>" method="POST" enctype="multipart/form-data"
                        id="myForm">
                        <?php echo csrf_field(); ?>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        jQuery(".btn-submit").click(function(e) {
            ...
            jQuery.ajax({
                type: 'POST',
                url: "<?php echo e(route('addSkillApi')); ?>",
                data: {
                    name: name
                },
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/pages/skill-list.blade.php ENDPATH**/ ?>