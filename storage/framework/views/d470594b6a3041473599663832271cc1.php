                ...
                <div class="intro-y col-span-12 md:col-span-6 xl:col-span-4 box fitbox">
                    ...
                    <div class="p-5" style="word-break:break-all">
                        ...
                        <div class="h-40 2xl:h-56 image-fit">
                            ...
                            <img alt="Ads Video image" class="rounded-md" src="/<?php echo e($video['bannerImage']); ?>">

                        </div>

                        <a target="_blank"href="<?php echo e($video['link']); ?>" class="block font-medium text-base mt-5"

                            style="color: blue;height:60px"><?php echo e($video['link']); ?></a>

                        <div class="text-slate-600 dark:text-slate-500 mt-2">

                            <p><b>Channel:</b> <?php echo e($video['channel']); ?></p>

                            <p><b>News Date:</b>

                                <?php echo e(date('d-m-Y', strtotime($video['newsDate'])) ? date('d-m-Y', strtotime($video['newsDate'])) : '--'); ?>
                    ...
                    <div
                        ...
                        <a id="editbtn" href="javascript:;"
                            ...
                            onclick="editbtn(<?php echo e($video['id']); ?> , '<?php echo e($video['link']); ?>','<?php echo e($video['bannerImage']); ?>', '<?php echo e($video['description']); ?>','<?php echo e($video['channel']); ?>','<?php echo e($video['newsDate']); ?>')"
                        ...
                        <div
                            ...
                            <input class="toggle-class show-code form-check-input mr-0 ml-3" type="checkbox"
                                ...
                                onclick="editNewsStatus(<?php echo e($video['id']); ?>,<?php echo e($video['isActive']); ?>)" href="$video['id']"
                                ...
                                <div class="sm:grid grid-cols gap-2">
                                    ...
                                    <div class="input">
                                        ...
                                        <div>
                                            ...
                                            <textarea onkeypress="return validateJavascript(event);" class="form-control" id="edescription" name="description" required></textarea>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    ...
                    <form action="<?php echo e(route('newsStatusApi')); ?>" method="POST" enctype="multipart/form-data">
        ...
        jQuery(function() {
            ...
            jQuery('#edit-form').submit(function(e) {
                ...
                jQuery.ajax({
                    ...
                    url: "<?php echo e(route('editNewsApi')); ?>",
        ...
        jQuery(function() {
            ...
            jQuery('#add-form').submit(function(e) {
                ...
                jQuery.ajax({
                    ...
                    url: "<?php echo e(route('addNewsApi')); ?>",
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/pages/news.blade.php ENDPATH**/ ?>