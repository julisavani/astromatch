            ...
            <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="intro-y col-span-12 md:col-span-6 box">
                    ...
                    <div class="px-5 pt-5 text-slate-600 dark:text-slate-500">
                        <h2 class="font-medium text-xl"><?php echo e($page->title); ?></h2>
                    </div>
                    <div class="p-5 text-slate-600 dark:text-slate-500"><?php echo $page->description; ?></div>
                    <div
                        ...
                        <div class="w-full flex text-slate-500 text-xs sm:text-sm">
                            ...
                            onclick="editbtn(<?php echo e($page->id); ?>,'<?php echo e($page->title); ?>','<?php echo e($page->type); ?>',<?php echo e(json_encode($page->description)); ?>)"
                    ...
                    mt-3 sm:mt-0">
                            <input class="toggle-class show-code form-check-input mr-0 ml-3" type="checkbox"
                                ...
                                <?php echo e($page->isActive ? 'checked' : ''); ?>

                                onclick="editpageStatus(<?php echo e($page->id); ?>,<?php echo e($page->isActive); ?>)" href="$page->id"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <form action="<?php echo e(route('pageStatusApi')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <form action="<?php echo e(route('deletepage')); ?> " method="POST">
                        <?php echo csrf_field(); ?>
    ...
    <script type="text/javascript">
        ...
        jQuery(function() {
            jQuery('#edit-form').submit(function(e) {
                ...
                jQuery.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('editpageApi')); ?>",
                    data: data,
                    dataType: 'JSON',
                    processData: false,
                    contentType: false,
        ...
        jQuery(function() {
            jQuery('#add-form').submit(function(e) {
                ...
                jQuery.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('addpageApi')); ?>",
                    data: data,
                    dataType: 'JSON',
                    processData: false,
                    contentType: false,
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/pages/pages.blade.php ENDPATH**/ ?>