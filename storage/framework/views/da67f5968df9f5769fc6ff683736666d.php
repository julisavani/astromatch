                                    ...
                                    <div class="pt-0 mb-1">
                                        <a class="card-link btn m-1 bg-white text-dark border-red font-14 font-weight-semi-bold titlecase rounded-25 mt-2"
                                            ...
                                            href="#card-element-1">Calendar&nbsp;<i class="fa fa-caret-down"
                                                ...
                                                ?>
                                       <a class="btn m-1 <?php echo e($todayActive ? 'bg-red text-white' : 'bg-white text-dark'); ?> border-red font-14 font-weight-semi-bold titlecase rounded-25 mt-2" href="<?php echo e(route('front.getPanchang')); ?>">TODAY&nbsp;
                                        </a>
                                            <a class="btn m-1 <?php echo e($tomorrowActive ? 'bg-red text-white' : 'bg-white text-dark'); ?> border-red font-14 font-weight-semi-bold titlecase rounded-25 mt-2" href="<?php echo e(route('front.getPanchang', ['panchangDate' => date('Y-m-d', strtotime('+1 day'))])); ?>">TOMORROW&nbsp;
                                          </a>
                                    </div>
                                            ...
                                            <div class="px-3 pb-1 rounded shadow-pink">
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center pt-2 pb-3">
                                                            ...
                                                            <a href="<?php echo e(route('front.getPanchang')); ?>" class="monthbox high"><?php echo e(date('M')); ?></a>
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                                                        <?php for($day = 1; $day <= 30; $day++): ?>
                                                            ...
                                                            ?>
                                                            <a href="<?php echo e(route('front.getPanchang', ['panchangDate' => $fullDate])); ?>" class="daybox p-1 m-1<?php echo e(request('panchangDate', date('Y-m-d')) == $fullDate ? ' high' : ''); ?>"><?php echo e($day); ?></a>
                                                        <?php endfor; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="shadow-pink rounded h-100">
                                            ...
                                            <div class="Choghadiya_img_day px-3 pt-3 font-14">
                                                ...
                                                <div class="row border-bottom">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['recordList']['response']['tithi']['name']); ?></p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row border-bottom">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['recordList']['response']['nakshatra']['name']); ?></p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row border-bottom">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['recordList']['response']['yoga']['name']); ?></p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row border-bottom">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['recordList']['response']['karana']['name']); ?></p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row border-bottom">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['recordList']['response']['rasi']['name']); ?></p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="shadow-pink rounded h-100">
                                            ...
                                            <div class="Choghadiya_img_day px-3 pt-3 font-14">
                                                <div class="row border-bottom">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['recordList']['response']['advanced_details']['sun_rise']); ?></p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['recordList']['response']['advanced_details']['sun_set']); ?></p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['recordList']['response']['advanced_details']['moon_rise']); ?></p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['recordList']['response']['advanced_details']['moon_set']); ?></p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['recordList']['response']['advanced_details']['next_full_moon']); ?></p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['recordList']['response']['advanced_details']['next_new_moon']); ?></p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['recordList']['response']['advanced_details']['masa']['amanta_name']); ?></p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['recordList']['response']['advanced_details']['masa']['paksha']); ?></p>
                                                    </div>
                                                </div>
                                                <div class="row border-bottom pt-2">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-2"><?php echo e($getPanchang['recordList']['response']['advanced_details']['masa']['purnimanta_name']); ?></p>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/frontend/pages/panchang.blade.php ENDPATH**/ ?>