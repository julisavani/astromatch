                                ...
                                <li class="w-100 overflow-hidden"><a
                                    ...
                                    <span class="font-12 d-block"> Exp :<?php echo e($astrologer['experienceInYears']); ?> Years</span>
                                        ...
                                        <span class="font-12 font-weight-semi-bold d-flex"> <span class="exprt-price">
                                                <?php echo e($currency['value']); ?><?php echo e($astrologer['reportRate']); ?>/Report</span></span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3 ml-5">
                                            ...
                                            <a class="btn-block btn btn-report  align-items-center " role="button"
                                                data-toggle="modal"
                                                <?php if(!authcheck()): ?> data-target="#loginSignUp" <?php else: ?> data-target="#intake" <?php endif; ?>>Get Report
                                                </a>
                            ...
                            <div class="col-lg-12 col-12 ">
                                <div class="mb-3 ">
                                    ...
                                    <form class="px-3 font-14" method="post" id="intakeForm">
                                        ...
                                        <input type="hidden" name="reportRate" id="reportRate" value="<?php echo e($astrologer['reportRate']); ?>">
                                        <div class="row">
                                            <div class="col-12 col-md-6 py-2">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="reportType" name="reportType">
                                                        ...
                                                        <option value="<?php echo e($getReportType['id']); ?>" ><?php echo e($getReportType['title']); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            </div>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/frontend/pages/astrologer-report-list.blade.php ENDPATH**/ ?>