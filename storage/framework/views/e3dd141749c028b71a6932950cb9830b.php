                    ...
                    <div class="col-4">
                        <div class="content-outer">
                            ...
                            <div class="content-desc mt-2">
                                ...
                                <a class="post-title h3" href="<?php echo e(route('front.getBlogDetails', ['id' => $getblog['id']])); ?>"
                                    style="word-break: break-all;"><?php echo e($getblog['title']); ?></a>

                                <p class="read-more" style="color:#B0121B"><a
                                        href="<?php echo e(route('front.getBlogDetails', ['id' => $getblog['id']])); ?>"
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/frontend/pages/blogs.blade.php ENDPATH**/ ?>