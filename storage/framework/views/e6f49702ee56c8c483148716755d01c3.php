                    ...
                    <div id="step1"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" id="name" value="<?php echo e(old('name')); ?>" name="name" class="form-control rounded" maxlength="20" >
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" id="countryCode" value="<?php echo e(old('countryCode')); ?>" placeholder="+91" name="countryCode"
                                        class="form-control rounded-left" style="max-width: 60px;" maxlength="20" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text" value="<?php echo e(old('hearAboutAstroguru')); ?>" id="hearAboutAstroguru" name="hearAboutAstroguru"
                                    class="form-control rounded"  maxlength="20">
                            </div>
                            <div class="col-6 mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                <label for="interviewSuitableTime">What is suitable time for interview?<span
                                        class="color-red font-weight-bold">*</span></label>
                                <input type="text" value="<?php echo e(old('interviewSuitableTime')); ?>" id="interviewSuitableTime" name="interviewSuitableTime" class="form-control rounded" maxlength="20" >
                            </div>
                            <div class="col-6 mb-3">
                        ...
                        <div class="row">
                            <div class="col-6 mb-3">
                                ...
                                <input type="text" value="<?php echo e(old('minimumEarning')); ?>" id="minimumEarning" name="minimumEarning"
                                    class="form-control rounded"  maxlength="10"
                            </div>
                            <div class="col-6 mb-3">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <textarea id="loginBio"  name="loginBio" class="form-control rounded" maxlength="50"><?php echo e(old('loginBio')); ?></textarea>
                            </div>
                            <div class="col-6 mb-3">
                                <label for="goodQuality">What are some good qualities of perfect astrologer?<span
                                        class="color-red font-weight-bold">*</span></label>
                                <textarea id="goodQuality"  name="goodQuality" class="form-control rounded" maxlength="50"><?php echo e(old('goodQuality')); ?></textarea>
                            </div>
                            <div class="col-6 mb-3">
                                ...
                                <textarea id="biggestChallenge"  name="biggestChallenge" class="form-control rounded" maxlength="50"><?php echo e(old('biggestChallenge')); ?></textarea>
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <textarea id="whatwillDo"  name="whatwillDo" class="form-control rounded" maxlength="50"><?php echo e(old('whatwillDo')); ?></textarea>
                            </div>
                        </div>
                        <div class="col-12 text-center">
                            <a class="btn btn-chat btn-chat-lg font-weight-bold px-5 py-2"
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/frontend/astrologers/pages/astrologers-registration.blade.php ENDPATH**/ ?>