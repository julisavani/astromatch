                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $wallet; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="intro-x">
                            ...
                            <td>
                                <div class="w-10 h-10 image-fit zoom-in">
                                        <img class="rounded-full"
                                            src="/<?php echo e($request->userProfile); ?>"
                                            onerror="this.onerror=null;this.src='/build/assets/images/person.png';"
                                            alt="Astrologer image" />
                                </div>
                            </td>
                            <td>
                                <div class="font-medium whitespace-nowrap"><?php echo e($request->userName); ?>

                                   </div>
                           </td>
                                <td>
                                <div class="font-medium whitespace-nowrap">
                                   <?php echo e($request->userContact); ?></div>
                           </td>
                            <td>
                                <div class="font-medium whitespace-nowrap"><?php echo e($request->amount); ?></div>
                            </td>
                            <td>
                            ...
                            <td>
                                 <?php echo e(ucwords($request->paymentMode)); ?>


                            </td>
    
                            <td>
                                <div class="font-medium whitespace-nowrap"><?php echo e($request->paymentStatus); ?></div>
                            </td>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/pages/wallet-history.blade.php ENDPATH**/ ?>