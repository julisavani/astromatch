                ...
                <div class="col-md-12 d-flex align-items-center">
                    <span style="text-transform: capitalize; ">
                        <span class="text-white breadcrumbs">
                            ...
                            <i class="fa fa-chevron-right"></i> <a href="<?php echo e(route('front.kundaliMatch')); ?>"
                            ...
                            <div class="bg-pink looks-1 d-flex p-2 py-3 p-sm-3 overflow-hidden position-relative">
                                ...
                                <div
                                    ...
                                    <div class="looks-img-box position-relative"><img
                                            src="<?php echo e(asset('public/frontend/astrowaycdn/astroway/web/content/images/ads/indian-bride-ads.png')); ?>">
                                    </div>
                                </div>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/frontend/pages/kundali-matching.blade.php ENDPATH**/ ?>