                        ...
                        <div class="py-2 px-4 border-bottom d-none d-lg-block">
                            <div class="d-flex align-items-center py-1">
                                ...
                                <div class="flex-grow-1 pl-3">
                                    <strong><?php echo e($getAstrologer['recordList'][0]['name']); ?></strong>
                                    
                                </div>

                                <div id="timerContainer">
                                    <div class="text-muted small">Remaining : <span id="remainingTime"
                                            class="color-red"><?php echo e($chatrequest->chat_duration); ?> seconds &nbsp;</span><span>
                                            <form id="endChatForm" class="d-inline-block">
                                                <input type="hidden" name="chatId" value="<?php echo e($chatId); ?>">
...
<?php $__env->startSection('scripts'); ?>
    <script>
        ...
        var astrologerId = "<?php echo e($astrologerId); ?>";
        ...
        function renderMessage(message, receiverId) {
            ...
            var newupdateTime = new Date("<?php echo e($chatrequest->updated_at); ?>").toLocaleString('en-US', {
                year: 'numeric',
                month: '2-digit',
                day: '2-digit',
                hour: '2-digit',
            ...
            <?php if($getAstrologer['recordList'][0]['profileImage']): ?>
                var astroprofile = "/<?php echo e($getAstrologer['recordList'][0]['profileImage']); ?>";
            <?php else: ?>
                var astroprofile = "<?php echo e(asset('public/frontend/astrowaycdn/dashaspeaks/web/content/images/user-img-new.png')); ?>";
            <?php endif; ?>

            <?php if(authcheck()['profile']): ?>
            var userprofile="/<?php echo e(authcheck()['profile']); ?>";
            <?php else: ?>
            var userprofile="<?php echo e(asset('public/frontend/astrowaycdn/dashaspeaks/web/content/images/user-img-new.png')); ?>";
            <?php endif; ?>
        ...
        <div class="flex-shrink-1 bg-light rounded py-2 px-3 ml-3 mb-2">
            <div class="font-weight-bold mb-1"><?php echo e($getAstrologer['recordList'][0]['name']); ?></div>
            ...
            if (message.isEndMessage == true && (newtimestamp >= newupdateTime)) {
                ...
                // window.location.href = "<?php echo e(route('front.home')); ?>"; // Reload the page
            }
    ...
    <script>
       let timerInterval;
    $(document).ready(function() {
        let updateTime = new Date("<?php echo e($chatrequest->updated_at); ?>").getTime();
        let chatDuration = <?php echo e($chatrequest->chat_duration); ?>;
        ...
        function endChat() {
            ...
            $.ajax({
                url: "<?php echo e(route('api.endChatRequest', ['token' => $token])); ?>",
                type: 'POST',
                data: formData,
                success: function(response) {
                    toastr.success('Chat Ended Successfully');
                    sendMessage(userId, astrologerId, "<?php echo e(authcheck()['name']); ?> -> Chat Ended", true, null);
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/drodifyt/astromatch.drodifytechnology.com/resources/views/frontend/pages/chatpage.blade.php ENDPATH**/ ?>